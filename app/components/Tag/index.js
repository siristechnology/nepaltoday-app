	...
	return (
		<TouchableOpacity
			...
			style={StyleSheet.flatten([
				...
				outlineSecondaryIcon && [styles.outlineSecondary, { borderColor: colors.accent }],
		...
		>
			...
			<Text
				style={StyleSheet.flatten([
					...
					outlineSecondary && [styles.textOutlineSecondary, { color: colors.accent }],
					outlineSecondaryIcon && [styles.textOutlineSecondary, { color: colors.accent }],
