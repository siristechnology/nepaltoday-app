import { Card, CardChannelGrid, Header, Icon, SafeAreaView, Text, TextInput } from '@components'
			...
			<View style={{ padding: 20 }}>
				...
				>
					...
					<FlatList
						...
						renderItem={({ item, index }) => <CardChannelGrid image={item.image} title={item.title} />}
					/>
				</View>
			</View>
		</SafeAreaView>
