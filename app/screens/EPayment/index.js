		...
		switch (type.id) {
						...
						>
							...
							<View style={styles.digiNumber}>
								<View style={{ alignItems: 'center', flexDirection: 'row' }}>
									<Switch onValueChange={() => setIsSave((isSave) => !isSave)} value={isSave} />
			...
			case 3:
				return (
					<View>
						<Text body1>
							A secured browser will be lauched that provides additional security for banking transaction,
							credit card number and other sensitive personal data
						</Text>
					</View>
				)
