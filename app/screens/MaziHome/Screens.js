...
import { FlatList, ImageBackground, TouchableOpacity, View, StyleSheet, ScrollView } from 'react-native'
			...
			<TouchableOpacity
				style={[
					styles.itemLeftScreen,
					{
						...
						backgroundColor: isSelect ? parseHexTransparency(colors.primary, 30) : 'transparent',
